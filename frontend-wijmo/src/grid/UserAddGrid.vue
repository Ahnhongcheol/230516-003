<template>
    <div style="max-height:80vh;">
        ...
        <UserViweQuery @search="search"></UserViweQuery>
        ...
        >
            <wj-flex-grid-filter :filterColumns="['tenantId','useStatus','userId','pass','userName',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="tenantId" header="tenantId" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="useStatus" header="useStatus" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="userId" header="userId" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="pass" header="pass" width="2*" :isReadOnly="true" align="center" />
...
<script>
import UserViweQuery from '../components/UserViweQuery.vue';
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.userAdd.href;
